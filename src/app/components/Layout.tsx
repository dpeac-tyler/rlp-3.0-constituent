...
function LayoutContent() {
  ...
  const isInspectionsActive = location.pathname.startsWith("/inspections");
  const isAssetInspectionsActive = location.pathname.startsWith("/asset-inspections");
      ...
      <div className="flex w-full flex-1" style={{ position: "relative" }}>
        ...
        >
          ...
          <nav className="flex flex-col">
            ...
            <NavItem
              label="Inspections"
              isActive={isInspectionsActive}
              isExpanded={isExpanded}
              to="/inspections"
              icon={
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M19 3h-4.18C14.4 1.84 13.3 1 12 1s-2.4.84-2.82 2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2m-7 0c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1m-2 14-4-4 1.41-1.41L10 14.17l6.59-6.59L18 9z" fill="#757575" />
                </svg>
              }
            />
            <NavItem
            ...
            <NavItem
              label="Inspections"
              isActive={isAssetInspectionsActive}
              isExpanded={isExpanded}
              to="/asset-inspections"
              backgroundColor="#E9F2F6"
              icon={
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M19 3h-4.18C14.4 1.84 13.3 1 12 1s-2.4.84-2.82 2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2m-7 0c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1m-2 14-4-4 1.41-1.41L10 14.17l6.59-6.59L18 9z" fill="#005EA2" />
                </svg>
              }
            />
            <NavItem
